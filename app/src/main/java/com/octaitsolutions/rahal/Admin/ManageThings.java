...
public class ManageThings extends AppCompatActivity {
    ...
    {
        rootReference.child("Things").child(selectedCountry).child(selectedCity).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if(key != null)
                    {
                        rootReference.child("Things").child(selectedCountry).child(selectedCity).child(key).addListenerForSingleValueEvent(new ValueEventListener() {
                            @Override
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                LinearLayoutManager layoutManager = new LinearLayoutManager(ManageThings.this, LinearLayoutManager.VERTICAL, false);

                                recyclerView.setLayoutManager(layoutManager);
                                recyclerView.setItemAnimator(new DefaultItemAnimator());

                                adapter = new ManageAdapter(ManageThings.this, list , ManageThings.this , selectedCountry , selectedCity, "Things");
