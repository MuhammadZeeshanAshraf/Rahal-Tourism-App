...
public class ManageShopping extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manage_shopping);
    ...
    {
        rootReference.child("Shopping").child(selectedCountry).child(selectedCity).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if(key != null)
                    {
                        rootReference.child("Shopping").child(selectedCountry).child(selectedCity).child(key).addListenerForSingleValueEvent(new ValueEventListener() {
                            @Override
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                LinearLayoutManager layoutManager = new LinearLayoutManager(ManageShopping.this, LinearLayoutManager.VERTICAL, false);

                                recyclerView.setLayoutManager(layoutManager);
                                recyclerView.setItemAnimator(new DefaultItemAnimator());

                                adapter = new ManageAdapter(ManageShopping.this, list , ManageShopping.this , selectedCountry , selectedCity, "Shopping");
