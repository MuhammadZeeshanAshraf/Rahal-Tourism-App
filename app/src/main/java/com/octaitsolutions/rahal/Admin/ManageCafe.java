...
public class ManageCafe extends AppCompatActivity {
    ...
    {
        rootReference.child("Cafe").child(selectedCountry).child(selectedCity).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if(key != null)
                    {
                        rootReference.child("Cafe").child(selectedCountry).child(selectedCity).child(key).addListenerForSingleValueEvent(new ValueEventListener() {
                            @Override
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                LinearLayoutManager layoutManager = new LinearLayoutManager(ManageCafe.this, LinearLayoutManager.VERTICAL, false);

                                recyclerView.setLayoutManager(layoutManager);
                                recyclerView.setItemAnimator(new DefaultItemAnimator());

                                adapter = new ManageAdapter(ManageCafe.this, list , ManageCafe.this , selectedCountry , selectedCity , "Cafe");
