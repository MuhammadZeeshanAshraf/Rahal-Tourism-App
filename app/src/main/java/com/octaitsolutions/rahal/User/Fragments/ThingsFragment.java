...
public class ThingsFragment extends Fragment implements OnMapReadyCallback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mapView.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(GoogleMap googleMap) {
                ...
                googleMap.addMarker(new MarkerOptions().position(lahore).title("Things To Do"));
                googleMap.addMarker(new MarkerOptions().position(shah).title("Things To Do"));
                googleMap.addMarker(new MarkerOptions().position(uet).title("Things To Do"));
